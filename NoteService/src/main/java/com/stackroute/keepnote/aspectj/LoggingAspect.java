...
private static final Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
	...
	public void logBeforecreateNote(JoinPoint joinPoint) {
	...
	public void logAftercreateNote(JoinPoint joinPoint) {
	...
	public void logAfterReturningcreateNote(JoinPoint joinPoint, Object result) {
	...
	public void logAfterThrowingcreateNote(JoinPoint joinPoint, Throwable error) {

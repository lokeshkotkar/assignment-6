 ...
 * for every method in controller is called first this filter gets called
 */
...
public class JwtFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		System.out.println("Before OPTIONS " + servletRequest.getMethod());
		if ("OPTIONS".equals(servletRequest.getMethod())) {
			System.out.println("IN OPTIONS " + servletRequest.getMethod());
			servletResponse.setStatus(HttpServletResponse.SC_OK);
			System.out.println("Going to filter Chain " + request);
